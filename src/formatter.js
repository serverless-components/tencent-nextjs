...
const formatStaticCosInputs = async (cosConf, appId, codeZipPath, region) => {
    try {
        ...
        throw new error_1.ApiTypeError(`UTILS_${CONFIGS.framework.toUpperCase()}_prepareStaticCosInputs`, e.message, e.stack);
    }
};
...
const formatStaticCdnInputs = async (cdnConf, origin) => {
    ...
    if (cdnConf.https) {
        ...
        if (!cdnConf.https.certId) {
            throw new error_1.ApiTypeError(`PARAMETER_${CONFIGS.framework.toUpperCase()}_HTTPS`, 'https.certId is required');
        }
...
const formatInputs = (state, inputs = {}) => {
    ...
    const functionConf = Object.assign(tempFunctionConf, {
        code: {
            src: inputs.src,
            bucket: (_c = inputs === null || inputs === void 0 ? void 0 : inputs.srcOriginal) === null || _c === void 0 ? void 0 : _c.bucket,
            object: (_d = inputs === null || inputs === void 0 ? void 0 : inputs.srcOriginal) === null || _d === void 0 ? void 0 : _d.object,
        },
        name: (_g = (_f = (_e = tempFunctionConf.name) !== null && _e !== void 0 ? _e : inputs.functionName) !== null && _f !== void 0 ? _f : stateFunctionName) !== null && _g !== void 0 ? _g : utils_1.getDefaultFunctionName(),
        region: region,
        role: (_j = (_h = tempFunctionConf.role) !== null && _h !== void 0 ? _h : inputs.role) !== null && _j !== void 0 ? _j : '',
        handler: (_l = (_k = tempFunctionConf.handler) !== null && _k !== void 0 ? _k : inputs.handler) !== null && _l !== void 0 ? _l : CONFIGS.handler,
        runtime: (_o = (_m = tempFunctionConf.runtime) !== null && _m !== void 0 ? _m : inputs.runtime) !== null && _o !== void 0 ? _o : CONFIGS.runtime,
        namespace: (_q = (_p = tempFunctionConf.namespace) !== null && _p !== void 0 ? _p : inputs.namespace) !== null && _q !== void 0 ? _q : CONFIGS.namespace,
        description: (_s = (_r = tempFunctionConf.description) !== null && _r !== void 0 ? _r : inputs.description) !== null && _s !== void 0 ? _s : CONFIGS.description,
        layers: (_u = (_t = tempFunctionConf.layers) !== null && _t !== void 0 ? _t : inputs.layers) !== null && _u !== void 0 ? _u : [],
        ...
        memorySize: (_x = tempFunctionConf.memorySize) !== null && _x !== void 0 ? _x : CONFIGS.memorySize,
        tags: (_z = (_y = tempFunctionConf.tags) !== null && _y !== void 0 ? _y : inputs.tags) !== null && _z !== void 0 ? _z : null,
    });
    ...
    if (CONFIGS.framework === 'django') {
        functionConf.projectName =
            (_3 = (_2 = (_1 = tempFunctionConf.projectName) !== null && _1 !== void 0 ? _1 : tempFunctionConf.djangoProjectName) !== null && _2 !== void 0 ? _2 : inputs.djangoProjectName) !== null && _3 !== void 0 ? _3 : '';
    }
    // TODO: 验证流量配置，将废弃
    ...
    const apigatewayConf = Object.assign(tempApigwConf, {
        serviceId: (_6 = (_5 = tempApigwConf.serviceId) !== null && _5 !== void 0 ? _5 : tempApigwConf.id) !== null && _6 !== void 0 ? _6 : inputs.serviceId,
        region: region,
        isDisabled: tempApigwConf.isDisabled === true,
        serviceName: (_9 = (_8 = (_7 = tempApigwConf.serviceName) !== null && _7 !== void 0 ? _7 : tempApigwConf.name) !== null && _8 !== void 0 ? _8 : inputs.serviceName) !== null && _9 !== void 0 ? _9 : utils_1.getDefaultServiceName(),
        serviceDesc: (_11 = (_10 = tempApigwConf.serviceDesc) !== null && _10 !== void 0 ? _10 : tempApigwConf.description) !== null && _11 !== void 0 ? _11 : utils_1.getDefaultServiceDescription(),
        ...
        apigatewayConf.endpoints = [
            {
                ...
                enableCORS: (_12 = tempApigwConf.enableCORS) !== null && _12 !== void 0 ? _12 : tempApigwConf.cors,
                serviceTimeout: (_13 = tempApigwConf.serviceTimeout) !== null && _13 !== void 0 ? _13 : tempApigwConf.timeout,
                ...
                function: {
                    ...
                    functionQualifier: (tempApigwConf.function && tempApigwConf.function.functionQualifier) ||
